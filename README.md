...
<a href="https://github.com/Sairaj213/agile-final-project">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=36&duration=3000&pause=1000&color=6C63FF&center=true&vCenter=true&multiline=true&repeat=true&width=800&height=100&lines=%F0%9F%9B%92+Product+Catalog+Service;Agile+%26+Scrum+Final+Project" alt="Product Catalog Service — Agile & Scrum Final Project" />
</a>

<br/>

<!-- Subtle tagline -->
<img src="https://readme-typing-svg.demolab.com?font=Inter&weight=400&size=18&duration=4000&pause=2000&color=A0A0A0&center=true&vCenter=true&repeat=true&width=700&height=30&lines=A+back-end+e-commerce+product+catalog+built+with+Agile+%26+Scrum+best+practices" alt="tagline" />

<br/><br/>

<!-- ── Badges Row 1: Project Metadata ── -->

![GitHub repo size](https://img.shields.io/github/repo-size/Sairaj213/agile-final-project?style=for-the-badge&logo=github&logoColor=white&color=6C63FF)
![GitHub issues](https://img.shields.io/github/issues/Sairaj213/agile-final-project?style=for-the-badge&logo=github&logoColor=white&color=FF6B6B)
![GitHub milestones](https://img.shields.io/github/milestones/open/Sairaj213/agile-final-project?style=for-the-badge&logo=target&logoColor=white&color=4ECDC4)
![Last commit](https://img.shields.io/github/last-commit/Sairaj213/agile-final-project?style=for-the-badge&logo=git&logoColor=white&color=FFE66D)

<br/>

<!-- ── Badges Row 2: Tech & Methodology ── -->

![Methodology](https://img.shields.io/badge/Methodology-Agile%20%2F%20Scrum-6C63FF?style=for-the-badge&logo=scrumalliance&logoColor=white)
![Sprint](https://img.shields.io/badge/Sprint-2%20Weeks-4ECDC4?style=for-the-badge&logo=clockify&logoColor=white)
![Board](https://img.shields.io/badge/Board-Kanban-FF6B6B?style=for-the-badge&logo=trello&logoColor=white)
![Stories](https://img.shields.io/badge/User%20Stories-10-FFE66D?style=for-the-badge&logo=readme&logoColor=black)
...
graph LR
    subgraph "🌐 Client Layer"
        A["🛒 E-Commerce Frontend"]
        B["📱 Mobile App"]
        C["🔗 Third-Party APIs"]
    end

    subgraph "⚙️ Product Catalog Service"
    ...
    style D fill:#4ECDC4,stroke:#4ECDC4,color:#fff
    style E fill:#FF6B6B,stroke:#FF6B6B,color:#fff
    style F fill:#FF6B6B,stroke:#FF6B6B,color:#fff
    style G fill:#FF6B6B,stroke:#FF6B6B,color:#fff
    style H fill:#FFE66D,stroke:#FFE66D,color:#333
    style I fill:#A8E6CF,stroke:#A8E6CF,color:#333
    style J fill:#A8E6CF,stroke:#A8E6CF,color:#333
```
...
```mermaid
pie title Story Distribution
    "Sprint 1 (In Progress)" : 4
    "Product Backlog" : 6
```
...
graph LR
    ...
    style B fill:#DDD6FE,stroke:#8B5CF6,color:#333
    style C fill:#BFDBFE,stroke:#3B82F6,color:#333
    style D fill:#FDE68A,stroke:#F59E0B,color:#333
    style E fill:#FCA5A5,stroke:#EF4444,color:#333
    style F fill:#A7F3D0,stroke:#10B981,color:#333
    style G fill:#6EE7B7,stroke:#059669,color:#fff
```
...
|:------|:-----:|:--------|:-----:|
| ![enhancement](https://img.shields.io/badge/enhancement-a2eeef?style=flat-square) | 🟦 | New feature or request | **8** |
| ![technical debt](https://img.shields.io/badge/technical%20debt-d93f0b?style=flat-square) | 🟥 | Technical debt or infrastructure items | **2** |
| ![bug](https://img.shields.io/badge/bug-d73a4a?style=flat-square) | 🔴 | Something isn't working | — |
| ![documentation](https://img.shields.io/badge/documentation-0075ca?style=flat-square) | 🔵 | Improvements or additions to docs | — |
| ![good first issue](https://img.shields.io/badge/good%20first%20issue-7057ff?style=flat-square) | 🟣 | Good for newcomers | — |
...
graph TB
    subgraph "🔄 Scrum Framework"
        A["📋 Product Backlog<br/><i>All 10 user stories</i>"]
        B["🎯 Sprint Planning<br/><i>Select top-priority stories</i>"]
        C["🏃 Sprint Backlog<br/><i>4 stories for Sprint 1</i>"]
        D["📅 Daily Standup<br/><i>What did I do? What will I do?<br/>Any blockers?</i>"]
        E["🔨 Development<br/><i>Build, test, iterate</i>"]
        F["👀 Sprint Review<br/><i>Demo to stakeholders</i>"]
        G["🔍 Sprint Retrospective<br/><i>What went well?<br/>What to improve?</i>"]
    end
    ...
    style C fill:#FFE66D,stroke:#FFE66D,color:#333
    style D fill:#FF6B6B,stroke:#FF6B6B,color:#fff
    style E fill:#A8E6CF,stroke:#A8E6CF,color:#333
    style F fill:#DDA0DD,stroke:#DDA0DD,color:#333
    style G fill:#F0E68C,stroke:#DAA520,color:#333
```
...
[![GitHub followers](https://img.shields.io/github/followers/Sairaj213?style=social)](https://github.com/Sairaj213)
[![GitHub stars](https://img.shields.io/github/stars/Sairaj213/agile-final-project?style=social)](https://github.com/Sairaj213/agile-final-project)
